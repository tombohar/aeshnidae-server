...
// This mod's own namespace is "Aeshnidae.Enlightenment", so the bare identifier
// "Enlightenment" resolves to the namespace rather than ACE's class. Alias it.
global using AceEnlightenment = ACE.Server.Entity.Enlightenment;
