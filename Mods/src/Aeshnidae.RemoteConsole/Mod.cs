...
///     assembly "Aeshnidae.RemoteConsole.dll"  ->  type "Aeshnidae.RemoteConsole.Mod"
...
{
    /// <summary>
    /// "Aeshnidae.RemoteConsole". Taken from the assembly rather than written out, so a
    /// rename cannot leave a stale literal behind.
    /// (Note: nameof(Aeshnidae.RemoteConsole) would yield just "Template" - nameof on a
    ...
    /// <summary>Folder this mod was loaded from, e.g. C:\ACEPublic\Mods\Aeshnidae.RemoteConsole</summary>
