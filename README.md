...
| [`Aeshnidae.Hud`](Mods/src/Aeshnidae.Hud/) | The HUD feed: server-described panels for clients that can draw them (OpenAC + the AeshHud plugin). Owns /hud and tells provider mods when to send. |
